...
public class ProductStockResponseDto {
    ...
    private Double advancedSellableStockComparison;
    private Double advancedInTransitStockComparison;
    private Double viewCountComparison;
    private Double likedCountComparison;
    private Double soldCountComparison;
    private Double priceMinComparison;
    private Double priceMaxComparison;
    private Double sellingPriceMinComparison;
